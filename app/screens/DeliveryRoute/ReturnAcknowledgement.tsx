...
interface ReturnAcknowledgementProps extends AppStackScreenProps<"ReturnAcknowledgement"> {}

export const ReturnAcknowledgementScreen: FC<ReturnAcknowledgementProps> = observer(
  function ReturnAcknowledgementScreen(_props) {
    ...
    return (
      <>
        <Screen>
          <Header title={"Return Acknowledgement"} leftIcon={"back"} onLeftPress={handleGoBack} />
          <View style={$view}>
